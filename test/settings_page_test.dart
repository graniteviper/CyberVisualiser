...
void main() {
  ...
  testWidgets('SettingsPage Connect to LG button saves connection settings without clicking Save Settings', (
    WidgetTester tester,
  ) async {
    ...
    final connectButton = find.widgetWithText(ElevatedButton, 'Connect to LG');
